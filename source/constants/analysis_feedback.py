...
class ExclusionReason:
    ...
    FILE_LIMIT_EXCEEDED: str = "Arquivo excluído porque o limite de {max_files} arquivos para análise foi excedido."
...
class Warnings:
    ...
    FILE_LIMIT_EXCEEDED: str = "Limite de {max_files} arquivos excedido. Ignorados: {ignored_files}"
