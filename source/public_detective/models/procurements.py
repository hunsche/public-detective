...
class Procurement(BaseModel):
    ...
    current_quality_score: int | None = None
    current_estimated_cost: Decimal | None = None
    current_potential_impact_score: int | None = None
    current_priority_score: int | None = None
