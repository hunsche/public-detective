...
class AnalysisRepository:
    ...
    def save_analysis(
        ...
        Args:
            ...
            is_thinking_mode: Whether the analysis used thinking mode.
    ...
    def save_pre_analysis(
        ...
        sql = text(
            ...
            INSERT INTO procurement_analyses (
                ...
                input_tokens_used, output_tokens_used, is_thinking_mode,
                cost_input_tokens, cost_output_tokens, total_cost
            ) VALUES (
                :procurement_control_number, :version_number, :status, :document_hash,
                :input_tokens_used, :output_tokens_used, :is_thinking_mode,
                :cost_input_tokens, :cost_output_tokens, :total_cost
