...
def test_pubsub_provider_initialization() -> None:
    ...
    """
    # Arrange
    with patch("providers.pubsub.LoggingProvider") as mock_logging_provider, patch(
        "providers.pubsub.ConfigProvider"
    ) as mock_config_provider, patch("threading.Lock") as mock_lock:
