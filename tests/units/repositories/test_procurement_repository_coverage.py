...
def test_extract_from_rar_bad_file(repo: ProcurementsRepository) -> None:
...
def test_create_zip_from_files_exception(repo: ProcurementsRepository) -> None:
...
@patch("requests.get")
def test_download_file_content_fails(mock_get: MagicMock, repo: ProcurementsRepository) -> None:
...
@patch("requests.head")
def test_determine_original_filename_fails(mock_head: MagicMock, repo: ProcurementsRepository) -> None:
...
@patch("requests.get")
def test_get_updated_procurements_request_exception(mock_get: MagicMock, repo: ProcurementsRepository) -> None:
...
@patch("requests.get")
def test_get_updated_procurements_no_ibge_codes(mock_get: MagicMock, repo: ProcurementsRepository) -> None:
...
def test_publish_procurement_to_pubsub_fails(repo: ProcurementsRepository, mock_procurement: Procurement) -> None:
...
def test_get_latest_version_none_found(repo: ProcurementsRepository) -> None:
...
@patch("requests.get")
def test_get_all_documents_metadata_no_content(
    mock_get: MagicMock, repo: ProcurementsRepository, mock_procurement: Procurement
) -> None:
...
def test_publish_procurement_to_pubsub_success(repo: ProcurementsRepository, mock_procurement: Procurement) -> None:
