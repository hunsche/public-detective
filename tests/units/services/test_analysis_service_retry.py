...
def test_retry_analyses_no_analyses_found(analysis_service_fixture):
    """
...
def test_retry_analyses_triggers_eligible_analysis(analysis_service_fixture):
    """
...
def test_retry_analyses_skips_ineligible_analysis_due_to_backoff(analysis_service_fixture):
    """
