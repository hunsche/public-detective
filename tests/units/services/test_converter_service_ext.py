...
def test_gif_to_mp4_conversion_failure(mock_get_reader, converter_service):
...
def test_bmp_to_png_conversion_failure(mock_image_open, converter_service):
...
def test_spreadsheet_to_csvs_xls_failure(mock_open_workbook, converter_service):
...
def test_spreadsheet_to_csvs_xlsx_failure(mock_load_workbook, converter_service):
...
def test_spreadsheet_to_csvs_xlsb_failure(mock_open_workbook, converter_service):
