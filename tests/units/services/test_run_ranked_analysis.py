...
def test_run_ranked_analysis_round_robin(analysis_service: AnalysisService) -> None:
    """Tests the round-robin logic for regional diversity."""
    ...
    assert [a.analysis_id for a in triggered_analyses] == [
        ...
        mock_analysis2_cityA.analysis_id,
    ]
